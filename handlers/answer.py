...
@labeler.message(text=["<!>аттиков<!>", "<!>Аттиков<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>договор<!>", "<!>Договор<!>"])
async def bye_handler(message: Message):

    if "оформ" in message.text.lower():
...
async def bye_handler(message: Message):
    if "комплектаци" in message.text.lower():
        ...
        await message.answer("Пол в бане утепляется керамзитом. Этот материал не боится влаги, а по "
                              ...
                              "керамзитом еще и парную, это будет стоить дополнительных денег.", attachment="photo-218711532_457239025")
...
@labeler.message(text=["<!>этап<!>оплат<!>", "<!>Этап<!>оплат<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>реквизиты<!>", "<!>Реквизиты<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>брон<!>", "<!>Брон<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>доставк<!>", "<!>Доставк<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!> стандартн<!>расчет<!>", "<!>расчет<!>стандартн<!>", "<!> Стандартн<!>расчет<!>", "<!>Расчет<!>стандартн<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>нестандартн<!>расчет<!>", "<!>расчет<!>нестандартн<!>", "<!>Нестандартн<!>расчет<!>", "<!>Расчет<!>нестандартн<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>утеплени<!>150<!>", "<!>Утеплени<!>150<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>стойки<!>террасы<!>", "<!>Стойки<!>террасы<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>Какой<!>крепеж<!>", "<!>какой<!>крепеж<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>регион<!>", "<!>Регион<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>гаранти<!>", "<!>Гаранти<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>образец<!>", "<!>Образец<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>Высота<!>построек<!>", "<!>высота<!>построек<!>"])
async def bye_handler(message: Message):
...
@labeler.message(text=["<!>зарплата<!>", "<!>Зарплата<!>"])
async def bye_handler(message: Message):
